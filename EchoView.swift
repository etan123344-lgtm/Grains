        ...
        ScrollView {
            VStack(spacing: 16) {
                ...
                if sample.echoEnabled {
                    ...
                    DSParamRow(
                        label: "Stereo Spread",
                        value: $sample.echoStereoSpread,
                        range: 0...1,
                        format: "%.0f%%",
                        displayMultiplier: 100
                    ) {
                        audioEngine.setEchoStereoSpread(sample.echoStereoSpread)
                    }
                    ...
                    Text("STEREO FEEDBACK DELAY — LOWPASS-DAMPED REPEATS, RIGHT CHANNEL OFFSET FOR WIDTH")
                        .font(DS.monoSmall)
